...
```{r, echo=FALSE}
require(knitr)
knitr::opts_knit$set(root.dir='C:/Users/elune/Documents/GitHub/TM-speech')
...
```
For the following analysis, we represent each president through index based on their term. And we refer to the following table to get the president name for necessary interpretation.
```{r}
